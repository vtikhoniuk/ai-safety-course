...
.PHONY: help serve stop status list \
        pull-gemma4 pull-qwen3 pull-qwen3-8 pull-llama2 pull-all \
        gemma4 qwen3 qwen3-8 llama2 \
        rm-gemma4 rm-qwen3 rm-qwen3-8 rm-llama2
...
help:
	...
	@echo "  make pull-all        — download all four"
	@echo ""
	...
	@echo ""
	@echo "  make rm-gemma4 | rm-qwen3 | rm-qwen3-8 | rm-llama2 — delete a model"
...
pull-all: pull-gemma4 pull-qwen3 pull-qwen3-8 pull-llama2
